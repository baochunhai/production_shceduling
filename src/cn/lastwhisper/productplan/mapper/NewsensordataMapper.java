...
public interface NewsensordataMapper {
    int deleteByPrimaryKey(@Param("recorddate") String recorddate, @Param("mpsno") String mpsno,
			@Param("processno") String processno);

	int insert(Newsensordata record);

	Newsensordata selectByPrimaryKey(@Param("recorddate") String recorddate, @Param("mpsno") String mpsno,
			@Param("processno") String processno);
